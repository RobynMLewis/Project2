...
| 1st Qu. |           9.00 |           246.00 |   4.00 |   1.00 |   0.00 |
| Median  |          10.00 |           398.00 |   7.00 |   1.00 |   0.00 |
| Mean    |          10.46 |           543.45 |  10.65 |   4.46 |   1.33 |
| 3rd Qu. |          12.00 |           689.00 |  13.00 |   3.00 |   1.00 |
| Max.    |          19.00 |          7081.00 | 304.00 | 100.00 |  59.00 |
...
![](TuesdayAnalysis_files/figure-gfm/distribution-1.png)<!-- -->
...
![](TuesdayAnalysis_files/figure-gfm/histograms-1.png)<!-- -->
...
![](TuesdayAnalysis_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](TuesdayAnalysis_files/figure-gfm/boxplots-1.png)<!-- --> \# Modeling
...
validation (LOOCV).
    ...
    ## Residual mean deviance:  99090000 = 5.124e+11 / 5171 
    ## Distribution of residuals:
    ##     Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
    ##  -6198.0  -1983.0  -1573.0      0.0   -472.8 438200.0

    plot(treeFit)
    text(treeFit, pretty=0)

![](TuesdayAnalysis_files/figure-gfm/tree-1.png)<!-- -->
